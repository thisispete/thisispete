...
(function() {
  ...
  module.exports = function(grunt) {
    ...
    return grunt.registerMultiTask('sitemap', 'sitemap description', function() {
      var changefreq, file, files, homeErrMess, pattern, priority, homepriority, root, rootWarnMess, sitemapPath, url, xmlStr, _i, _len;
      ...
      homepriority = (this.data.homepriority || 0.8).toString();
      ...
      for (_i = 0, _len = files.length; _i < _len; _i++) {
        ...
        xmlStr += "  <priority>" + (file.url.match(/\//g).length == 3 ? homepriority : priority) + "</priority>\n";
        xmlStr += "</url>\n";
      }
      xmlStr += '</urlset>';
